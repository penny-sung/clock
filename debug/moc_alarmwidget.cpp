...
static constexpr auto qt_meta_stringdata_ZN11AlarmWidgetE = QtMocHelpers::stringData(
    "AlarmWidget",
    "addAlarm",
    "",
    "checkAlarms",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11AlarmWidgetE[] = {
...
Q_CONSTINIT const QMetaObject AlarmWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11AlarmWidgetE.offsetsAndSizes,
    qt_meta_data_ZN11AlarmWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11AlarmWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AlarmWidget, std::true_type>,
        // method 'addAlarm'
...
void AlarmWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->selectMusic(); break;
        case 3: _t->deleteAlarm(); break;
        case 4: _t->triggerAlarm((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *AlarmWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11AlarmWidgetE.stringdata0))
