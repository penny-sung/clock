...
static constexpr auto qt_meta_stringdata_ZN11TimerWidgetE = QtMocHelpers::stringData(
    "TimerWidget",
    "startTimer",
    "",
    "pauseTimer",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11TimerWidgetE[] = {
...
Q_CONSTINIT const QMetaObject TimerWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11TimerWidgetE.offsetsAndSizes,
    qt_meta_data_ZN11TimerWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11TimerWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *TimerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11TimerWidgetE.stringdata0))
